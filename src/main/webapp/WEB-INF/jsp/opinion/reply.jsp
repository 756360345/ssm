...
<form action="" method="post" class="layui-form">
    <blockquote class="layui-elem-quote" style="align-content: center;">
        <button class="layui-btn layui-bg-red  layui-icon  layui-icon-chat"  id="save"  title="保存">保存</button>
    </blockquote>
    <div class="layui-row">
        ...
        <div class="layui-col-xs6 ">
            <div class="grid-demo">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="rephfnr" id="rephfnr" lay-verify="title" autocomplete="off" class="layui-input"  required lay-verify="required">	</div>
                </div>
            </div>
        </div>
        ...
        <div class="layui-col-xs6 ">
            <div class="grid-demo">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="repdworr" id="repdworr" lay-verify="title" autocomplete="off" class="layui-input"  required lay-verify="required">
                    </div>
                </div>
            </div>
        </div>
